    ...
    private var introCard: some View {
        VStack(spacing: Spacing.sm) {
            Image(systemName: "person.crop.rectangle.stack")
                ...
                .foregroundStyle(BrandColor.primary)
            Text("Compartilhe seus laudos em tempo real com o auxiliar")
                .font(TextStyle.subtitle)
                .foregroundStyle(AppSurface.textPrimary)
                .multilineTextAlignment(.center)
            Text("Gere um código e mostre pro auxiliar. Ele acessa laudousg.com/sala, digita o código e vê seu último laudo em segundos.")
                .font(TextStyle.body)
    ...
    private var instructionsCard: some View {
        VStack(alignment: .leading, spacing: Spacing.sm) {
            Text("Como funciona")
                ...
                .foregroundStyle(AppSurface.textSecondary)
                .textCase(.uppercase)
            instructionRow(number: "1", text: "O auxiliar abre laudousg.com/sala em qualquer navegador")
            instructionRow(number: "2", text: "Digita o código que está aqui no app")
            instructionRow(number: "3", text: "O laudo mais recente aparece em tempo real e atualiza sozinho")
        }
        .padding(Spacing.md)
